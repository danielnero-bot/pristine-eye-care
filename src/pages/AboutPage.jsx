  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="py-24 bg-white relative">
        <div className="w-24 h-1.5 bg-red-700 mx-auto mb-12 rounded-full"></div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-10 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_30px_-4px_rgba(227,52,47,0.1)] transition-all duration-300 border-t-4 border-transparent hover:border-red-700 cursor-default group">
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            <div className="group overflow-hidden rounded-2xl shadow-sm hover:shadow-md transition-all">
              <img 
                src="https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?q=80&w=600&auto=format&fit=crop" 
